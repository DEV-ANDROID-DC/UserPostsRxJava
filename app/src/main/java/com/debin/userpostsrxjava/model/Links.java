...
public class Links {
    ...
    @Expose
    private List<HttpsTechcrunchComEdit> httpsTechcrunchComEdit = null;
    ...
    public List<HttpsTechcrunchComEdit> getHttpsTechcrunchComEdit() {
        return httpsTechcrunchComEdit;
    }

    public void setHttpsTechcrunchComEdit(List<HttpsTechcrunchComEdit> httpsTechcrunchComEdit) {
        this.httpsTechcrunchComEdit = httpsTechcrunchComEdit;
    }
